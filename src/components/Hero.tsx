        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left space-y-6">
            ...
            <p className="text-lg text-gray-600 dark:text-neutral-300 max-w-xl leading-relaxed">
              Descubra uma coleção cuidadosamente curada para a mulher moderna.
              Peças exclusivas que unem sofisticação, conforto e caimento
              perfeito. Sinta-se empoderada todos os dias.
            </p>
